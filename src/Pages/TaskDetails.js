                                ...
                                <div className="bg-white p-4 rounded-lg ">
                                    ...
                                    <div className="shadow rounded-lg p-4">
                                        ...
                                        <div className="flex flex-wrap gap-3 ">
                                            <div className=" h-20 w-30 rounded-lg relative ">
                                                <img
                                                    src={Img1}
                                                    alt="Sample"
                                            ...
                                            <div className="h-20 w-20 flex flex-col  items-center justify-center bg-gray-200 rounded-lg cursor-pointer">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 my-4">
                                        <div className="shadow-md rounded-md p-4">
                                            ...
                                            <p className="text-4xl text-primary-0 font-bold ">
                                                12 <span className="text-2xl text-gray-1">Days</span>
                                            </p>
                                        </div>
                                        <div className="shadow-md rounded-md p-4">
                                            <h4 className="text-base font-bold">Actual Duration</h4>
                                            <p className="text-4xl text-primary-0 font-bold">
                                                18 <span className="text-2xl text-gray-1">Days</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
