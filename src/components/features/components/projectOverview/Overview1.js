        ...
        <div className="flex justify-center items-center">
            <div className="bg-white rounded-3xl p-5 border-2 w-full" style={{ background: "white" }}>
                <div className="flex justify-between items-center pr-4">
                    <div className="rounded-xl px-3 text-[14px] font-bold py-1" style={{ background: "rgba(236, 253, 243, 1)", letterSpacing: "1px", color: "rgba(18, 183, 106, 1)" }}>
                        Ongoing Project
                    </div>
                ...
                <p className="text-gray-500 mt-1 mb-4">Company Name</p>
                <div style={{ height: "1px", width: "100%", background: "lightgray" }}></div>

                <div className="mt-4">
                    <div className="flex justify-between mb-6">
                        <p className="font-bold text-base">Client: Alex John</p>
                    </div>
                    ...
                    <div className="flex flex-wrap -mx-2">
                        {items.map((item, index) => (
                            ...
                            >
                                <p className="font-medium text-sm text-gray-400 leading-4 mb-2">{item.name}</p>
